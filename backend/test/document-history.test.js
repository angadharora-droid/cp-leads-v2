...
import { downloadProposal, downloadContract, updateEnquiry, getIssuePdf } from '../src/services/enquiry.service.js';
...
function fixture(t, { contract = true } = {}) {
  ...
  const lead = { businessName: 'Original company', email: 'guest@example.test', reference: 'TEST', leadType: 'individual' };
